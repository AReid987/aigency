...
def initialize():
    ...
    utility_llm = models.get_ollama_chat(model_name="gemma2:latest")
    # change if you want to use a different utility model
    # utility_llm = models.get_groq_chat(model_name="llama-3.1-8b-instant", temperature=0)
